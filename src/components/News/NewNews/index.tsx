...
export default function NewNews() {
    ...
    const onSubmit = async (data: FormData) => {
        ...
        try {
            await axiosPrivate.post('/news/', new_data, {
                headers: {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className={classes.NewsAdd}>
            <div style={{ width: "100%", display: "flex", justifyContent: "space-between", alignItems: "center", alignSelf: "center" }}>
                ...
                <Text c="#6EB648" size='xl' fw={'initial'}> Yangilik qo`shish </Text>
