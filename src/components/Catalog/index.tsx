...
export function TableSort() {
  ...
  //    return  item.title.toLowerCase().includes(inptValue.toLowerCase())}
  //   )
  ...
  const filterData = (term: string) => {
    const filtered = category.filter((item) => {
      // Adjust this logic to match your data structure and search criteria
  ...
  const rows = category.map((row, index) => (
    <Table.Tr key={index}>
